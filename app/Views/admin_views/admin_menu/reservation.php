<div class="reservation-content mt-2">
    
    <h3 class="fw-bolder mt-5">Reservation</h3>
    <?php if(count($dataReservationTimeline) > 0) : ?>
        <?php for($i = 0; $i < count($dataReservationTimeline) - 5; $i++) : ?>
            <div id="<?=$dataReservationTimeline[$i]['id_tipe_kamar']?>_reservation-tl-card" class="reservation-tl-card rounded-2 mt-5 pt-2 pe-2 row row-cols-2 g-1 align-items-center">
